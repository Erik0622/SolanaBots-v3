        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-lg mx-auto">
            {connected ? (
              ...
              <WalletMultiButton className="!w-full sm:!w-auto !bg-gradient-to-r !from-blue-600 !to-purple-600 !text-white !font-bold !rounded-xl !px-8 !py-4 !transition-all !duration-300 hover:!scale-105 hover:!shadow-lg hover:!shadow-blue-500/25" />
            )}
