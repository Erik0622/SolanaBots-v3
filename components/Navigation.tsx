...
const NavigationClientContent: FC = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 px-6 py-4 transition-all duration-300 ${
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        {isClient ? <NavigationClientContent /> : (
          <div className="hidden md:flex items-center space-x-8">
             {/* Placeholder for non-client render or basic links */}
            <Link href="#bots" className="text-white/80 hover:text-primary transition-colors">Bots</Link>
            <Link href="/dashboard" className="text-white/80 hover:text-primary transition-colors">Dashboard</Link>
            <Link href="/launchpad" className="text-white/80 hover:text-primary transition-colors">Launchpad</Link>
